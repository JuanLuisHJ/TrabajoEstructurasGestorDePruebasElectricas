...
public class MenuInformes {
    ...
    public static void CrearInforme() throws IOException{
            ...
            if (indice>=0){
                ...
                if (prueba.NumInforme<0){
                    ...
                    for(Clases.Prueba pruebasin : Main.pruebas){
                        if (pruebasin.NumInforme<0){
                            System.out.println(pruebasin);
                            contador++;
                        }
                    }
                    if(contador==0){
                        System.out.println("Todas las pruebas tienen informe\n");
                    }
                    cancelarregistro=Main.CancelarRegistro();
                }
            }
        ...
        Clases.Informe nuevoinforme = new Clases.Informe(nuevoidentificador,resultado,comentarios,temperatura,humedad,presion);
        ...
        while (!salir){
            ...
            if (seleccion.equals("1")) {
                ...
                try{
                    ...
                    System.out.println("La prueba con este número de informe no se encuentra en la base de datos\n");
                }
            }
            else if (seleccion.equals("0")){
                salir=true;
                ...
                System.out.println("La opción de búsqueda única para informes es \"número de informe de prueba\", por favor digite \"1\" o \"0\"");
            }
        }
    }
    public static void EliminarInforme() throws IOException{
        ...
        while (!salir) {
            System.out.println("Seleccionar por:");
            System.out.println(" 1. Identificador de informe de prueba ");
            System.out.println(" 0. Cancelar");
            String seleccion = input.readLine();
            if (seleccion.equals("1")) {
